...
\textbf{Answer:}
 ...
 \textbf{Damping ratio:} choose the optimal, $\xi=0.707$.
 
 \textbf{Undamped natural frequency:} it depends on the application and the system capability. Take $\omega_{n}=10$ in this report.

 \textbf{Closed loop denominator}: $s^2+2\xi\omega_{n}s+\omega_{n}^2 \rightarrow s^2+14.14s+100$.

 From the closed loop denominator and steady state final value, we have:
 \begin{equation}
     \begin{cases}
         F_s = \left[\begin{array}{ccc}-13.54&-87.876\end{array}\right]\\
         H=100
     \end{cases}
 \end{equation}
