...
\begin{itemize}
    ...
    \item \textbf{Unit step response:} The unit step response in time domain is as shown in Fig. \ref{fig:PlantStepResponse}. This plant has a slow response speed and steady-state error.
        ...
        \begin{figure}[htbp]
          \centering
          \subfigure[Simulated step response in Simulink Linearlizer.\label{fig:PlantStepResponse}]{\includegraphics[width=0.45\textwidth]{Report/pics/PlantStepResponse.png}}
          \quad % or \hfill
